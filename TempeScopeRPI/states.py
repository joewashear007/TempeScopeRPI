...
def GetSchedule(type, param):
    schedules = {
        "mister": GetCloudSchedule,
        "fan": GetWindSchedule,
        "pump": GetRainSchedule
    }
    if type.lower() in schedules:
        return schedules[type.lower()](param)
    else:
        raise "Device Schedule Not Found!"